...
RUN pip install --no-cache-dir torch torchvision torchaudio transformers pandas datasets sentence-transformers evaluate optuna imblearn lime bitsandbytes
